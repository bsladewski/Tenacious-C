 ...
 * Used by Tool Curation to append verification requirements and agent skills to existing files
 */
...
/**
 * Agent skill file for formatting
 */
export interface AgentSkillForFormat {
  path: string;
  type: string;
  summary: string;
}
...
/**
 * Format agent skills section for appending to plan.md (table format)
 *
 * @param skills - List of agent skill files
 * @returns Formatted string ready to append
 */
export function formatAgentSkillsSectionForPlan(
  skills: AgentSkillForFormat[]
): string {
  if (skills.length === 0) {
    return `## Agent Skills (Auto-generated by Tool Curation)

No agent skill files were found in the repository. The executing agent should follow general best practices.`;
  }

  const header = `## Agent Skills (Auto-generated by Tool Curation)
...
/**
 * Format agent skills section for appending to requirements.txt (list format)
 *
 * @param skills - List of agent skill files
 * @returns Formatted string ready to append
 */
export function formatAgentSkillsSectionForRequirements(
  skills: AgentSkillForFormat[]
): string {
  if (skills.length === 0) {
    return `## Agent Skills (Auto-generated by Tool Curation)

No agent skill files were found in the repository. Follow general best practices.`;
  }
