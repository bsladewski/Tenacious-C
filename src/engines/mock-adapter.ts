...
## Discovery Summary
- Sources examined: package.json, .cursorrules, CLAUDE.md, .github/copilot-instructions.md
- Verification tools found: lint, test, build scripts in package.json
- Agent skill files found: .cursorrules, CLAUDE.md
...
## Mock Selected Agent Skills:

### File: \`.cursorrules\`
- **Type:** cursor-rules
- **Relevance:** Contains project coding standards applicable to all code changes
- **Key rules:** TypeScript strict mode, prefer functional patterns, test coverage requirements

### File: \`CLAUDE.md\`
- **Type:** claude-instructions
- **Relevance:** Contains architecture guidelines and naming conventions
- **Key rules:** Module boundaries, import conventions, error handling patterns
